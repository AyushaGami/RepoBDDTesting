...
public class DataStructure {
	...
	@When("The user clicks Get Started button in {string} panel")
	public void the_user_clicks_get_started_button_in_panel(String string) {
	    // Write code here that turns the phrase above into concrete actions
	    throw new io.cucumber.java.PendingException();
	}

	@Then("The user should able to view {string} Page")
	public void the_user_should_able_to_view_page(String string) {
	    // Write code here that turns the phrase above into concrete actions
	    throw new io.cucumber.java.PendingException();
	}
